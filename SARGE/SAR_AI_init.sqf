...
EAST setFriend [CIVILIAN, 0]; //extra side to hate zeds
...
RESISTANCE setFriend [CIVILIAN, 0]; //extra side to hate zeds

//make all ai hostile towards zombies
CIVILIAN setFriend [EAST, 0];
CIVILIAN setFriend [RESISTANCE, 0];

SAR_AI_friendly_side = resistance;
SAR_AI_unfriendly_side = east;
SAR_AI_zombie_side = civilian;
